...
%package static
Summary:	Static Eclipse Paho MQTT C client libraries
Summary(pl.UTF-8):	Statyczne biblioteki klienckie C Eclipse Paho MQTT
Group:		Development/Libraries
Requires:	%{name}-devel = %{version}-%{release}

%description static
Static Eclipse Paho MQTT C client libraries.

%description static -l pl.UTF-8
Statyczne biblioteki klienckie C Eclipse Paho MQTT.
